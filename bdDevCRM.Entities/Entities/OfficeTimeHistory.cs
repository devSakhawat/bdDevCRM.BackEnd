...
public partial class OfficeTimeHistory
{
    public int OfficeTimeHistoryId { get; set; }
    ...
    public DateTime? HistoryEffectStartDate { get; set; }

    public DateTime? HistoryEffectEndDate { get; set; }
}
