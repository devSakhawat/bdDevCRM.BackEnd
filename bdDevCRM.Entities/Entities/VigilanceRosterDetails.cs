...
public partial class VigilanceRosterDetails
{
    ...
    public int? Date27 { get; set; }

    public int? Date28 { get; set; }

    public int? Date29 { get; set; }

    public int? Date30 { get; set; }

    public int? Date31 { get; set; }
