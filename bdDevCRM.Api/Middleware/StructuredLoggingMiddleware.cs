...
public class StructuredLoggingMiddleware
{
  ...
  public async Task InvokeAsync(HttpContext context)
  {
    ...
    // Get everything from shared context — do not create new instances
    ...
    finally
    {
      ...
      // Get Controller/Action name from endpoint metadata
...
//		_captureContentTypes = _configuration.GetSection("Logging:StructuredLogging:CaptureContentTypes").Get<string[]>()
