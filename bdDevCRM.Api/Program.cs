...
// 1️⃣ Exception handler — MUST be outermost (catches all exceptions)
app.UseMiddleware<StandardExceptionMiddleware>();

// 2️⃣ Correlation ID + PipelineContext + Stopwatch start
app.UseMiddleware<CorrelationIdMiddleware>();

// 3️⃣ Performance monitoring (reads shared stopwatch from PipelineContext)
...
// 5️⃣ Enhanced audit (AFTER auth — needs context.User for userId)
