...
public class ModuleController : BaseApiController
{
  ...
  public async Task<IActionResult> ModuleSummary([FromBody] CRMGridOptions options)
  {
    ...
    if (moduleSummary == null)
      return Ok(ResponseHelper.NoContent<GridEntity<ModuleDto>>("No data found!"));

    return Ok(ResponseHelper.Success(moduleSummary, "Module summary retrieved successfully"));
  }
  ...
  public async Task<IActionResult> SaveModule([FromBody] ModuleDto moduleDto)
  {
    ...
    if (module == null)
      return Ok(ResponseHelper.NoContent<ModuleDto>("Failed to create module"));

    return Ok(ResponseHelper.Created(module, "Module created successfully"));
  }
  ...
  public async Task<IActionResult> UpdateModule([FromRoute] int key, [FromBody] ModuleDto moduleDto)
  {
    ...
    if (returnData == null)
      return Ok(ResponseHelper.NoContent<ModuleDto>("Failed to update module"));

    return Ok(ResponseHelper.Updated(returnData, "Module updated successfully"));
  }
  ...
  public async Task<IActionResult> DeleteModule([FromRoute] int key, [FromBody] ModuleDto moduleDto)
  {
    ...
    return Ok(ResponseHelper.Success("Module deleted successfully"));
  }
