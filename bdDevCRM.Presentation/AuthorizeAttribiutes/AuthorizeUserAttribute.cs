...
public class AuthorizeUserAttribute : Attribute, IAuthorizationFilter
{
  ...
  public void OnAuthorization(AuthorizationFilterContext context)
  {
    ...
    try
    {
      ...
      UsersDto? user = TryGetUserFromCache(memoryCache, userId, logger);
  ...
  /// </summary>
  private static UsersDto? TryGetUserFromCache(
      ...
      ILogger? logger)
  {
    try
    {
      var user = serviceManager.Users.GetUser(userId, trackChanges: false);
