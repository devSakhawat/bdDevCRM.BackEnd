...
//  Task<RefreshToken> GetByTokenAsync(string token, bool trackChanges);
...
//  Task<IEnumerable<RefreshToken>> GetByUserIdAsync(int userId, bool trackChanges);
...
//  Task<IEnumerable<RefreshToken>> GetActiveTokensByUserIdAsync(int userId, bool trackChanges);
